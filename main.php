    ...
    <nav class="navbar navbar-expand-lg navbar-light navv">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <li>
          <a class="nav-link  active btns mx-4" style="color: red" href="#" id="navbarDropdown"
              role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="document.getElementById('id04').style.display='block'">
              Admin Panel
            </a>
          </li>
